...
describe("RulesFilter", () => {
    ...
    it("renders rules and tags and handles clicks", async () => {
        ...
        render(_jsx(RulesFilter, { rules: rules, activeRules: activeRules, toggleRule: toggleRule, toggleAll: toggleAll, tags: tags, tagFilter: null, toggleTag: toggleTag, valueType: "score", switchDataBy: switchDataBy }));
